  ...
  const socialLinks = [
    {
      ...
      icon: <FaInstagram />,
      color: "bg-[#E1306C]",
      url: "https://instagram.com/2shigroup"
    },
    {
      name: "Telegram",
      icon: <SiTelegram />,
      color: "bg-[#0088cc]",
      url: "https://t.me/SHSHIGROUP"
    },
    {
      name: "WhatsApp",
      icon: <FaWhatsapp />,
      color: "bg-[#25D366]",
      url: "https://chat.whatsapp.com/F3nRfGFyPOcDT1qhHdvnSX"
    }, // اضافه شد

    {
      ...
      icon: <FaFacebookF />,
      color: "bg-[#4267B2]",
      url: "https://facebook.com/2shigroup"
    },
    {
      name: "Twitter",
      icon: <FaTwitter />,
      color: "bg-[#1DA1F2]",
      url: "https://twitter.com/2shigroup"
    },
    {
      name: "Youtube",
      icon: <FaYoutube />,
      color: "bg-[#ff0000]",
      url: "https://youtube.com/@2shigroup"
    },
    {
      name: "Aparat",
      icon: <SiAparat />,
      color: "bg-[#ed145b]",
      url: "https://aparat.com/2shigroup"
    },
    {
      name: "Linkedin",
      icon: <FaLinkedinIn />,
      color: "bg-[#2867B2]",
      url: "https://linkedin.com/in/2shigroup"
    },
    {
      name: "Github",
      icon: <FaGithub />,
      color: "bg-[#333]",
      url: "https://github.com/2shigroup"
    }
  ];
    ...
    <nav className="fixed z-40 top-1/2 -translate-y-1/2 w-[40px] shadow-lg transition-all duration-300 md:w-[60px] rounded-full ">
      <ul>
        {socialLinks.map((social, index) => (
          <li
            key={index}
            className="h-[36px] rounded-full  relative group md:h-[55px]"
          >
            <a
              href={social.url}
              target="_blank"
            ...
            >
              <i className="absolute   left-3 rtl:right-3 text-[20px] md:text-[24px]">
                {social.icon}
              </i>
